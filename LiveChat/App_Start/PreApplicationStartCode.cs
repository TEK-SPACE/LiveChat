    ...
    public class MyDnnVisitorsOnlineHttpModule : IHttpModule
    {
        ...
        private void page_LoadComplete(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (!page.ClientScript.IsClientScriptIncludeRegistered("MyDnnSupportLiveChatWidget"))
                    {
                        page.ClientScript.RegisterClientScriptInclude("MyDnnSupportLiveChatWidget", DotNetNuke.Common.Globals.ResolveUrl("~/DesktopModules/MVC/MyDnnSupport/LiveChat/Scripts/init-widget.js"));
                    }
                }
            }
            catch (Exception)
